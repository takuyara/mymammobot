dir_list = [
	...
	"E:\\nn-data\\MAMMOBOT\\data\\7Scenes\\CTCLDepthfiles\\depthmapsCL0Tangent",
	"E:\\nn-data\\MAMMOBOT\\data\\7Scenes\\CTCLDepthfiles\\depthmapsCL2Tangent",
...
for this_dir in dir_list:
	...
	for i in range(len(os.listdir(this_dir)) // 2):
		this_pose = np.loadtxt(os.path.join(this_dir, f"frame-{i:06d}.pose.txt"))
		this_num = this_pose.reshape(4, 4)[ : 3, 3]
