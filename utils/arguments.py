...
def get_base_parser(parser):
	...
	parser.add_argument("--train-preprocess", type = str, default = "mesh", choices = ["sfs2mesh", "mesh2sfs", "sfs", "mesh", "quantile", "hist_simple", "hist_complex", "hist_even_more_complex"])
	parser.add_argument("--val-preprocess", type = str, default = "sfs2mesh", choices = ["sfs2mesh", "mesh2sfs", "sfs", "mesh", "quantile", "hist_simple", "hist_complex", "hist_even_more_complex"])
