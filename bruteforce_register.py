...
def get_args():
	...
	parser.add_argument("--position-scale", type = float, default = 5)
	parser.add_argument("--orientation-scale", type = float, default = 0.3)
	parser.add_argument("--focal-samples", type = int, default = 5)
	parser.add_argument("--position-samples", type = int, default = 20)
