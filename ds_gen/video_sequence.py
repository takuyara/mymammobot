...
from ds_gen.camera_features import camera_params, dynamic_total_velocity_gen, dynamic_radial_norm_velocity_gen, dynamic_axial_direction_gen, dynamic_rotation_velocity_gen, check_valid_focal_radial_norm
			...
			for direction in range(2):
				...
				while len(points) - cur_idx > cut_ends:
					...
					while True:
						...
						if check_valid_focal_radial_norm(f_radial_norm, lumen_radius):
