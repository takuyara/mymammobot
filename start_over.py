	...
	def fun(img):
		...
		if training:
			...
			if aug:
				...
				img = transforms.ElasticTransform(alpha = 70., sigma = 6.)(img)
				img = transforms.RandomPerspective(distortion_scale = 0.25, p = 0.75)(img)
				img = transforms.RandomCrop(randu_gen(180, 224)())(img)
